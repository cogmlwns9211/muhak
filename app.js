...
router.get("/address", pagesController.showAddress);
router.get("/game", pagesController.showGame);
router.get("/onedayclass", pagesController.showOneDayClass);
router.get("/drinkonetime", pagesController.showDrinkOneTime);
